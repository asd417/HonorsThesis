...
The approaches surveyed above share a common design choice: the heuristic or policy network is fixed in architecture and trained by gradient descent. An alternative paradigm treats the architecture itself as a variable to be optimized through evolutionary computation. The following section surveys this direction.
